function read_Intan_RHDinfo_file(filename)

% this is a modification of the software provided by Intan to read .rhd
% files. Modifications are so that a filename can be supplied to the
% function and variables are returned as output arguments
%
% note that we are using the "One File Per Signal Type? Format, at least as
% of 20191120
%
...
% code below generates a dialog box in the original code from Intan
