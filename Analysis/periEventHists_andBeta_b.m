...
for iRat = 2 : length(ratIDs)
    ...
    %             tr_trialsOnly = extractTrial_ts(ts, trials);
        ...
        periEvent_beta_name = [neuronName '_periEventBeta_correctOnly.mat'];
        tsScalo_subject_dir = fullfile(analysis_storage_dir, [analysisConf.subjects__name '_spike_triggered_scalos']);
        ...
        save(periEvent_beta_name,'peri_eventMetadata','periRandomBeta','periRandomGamma','LTShist','all_tsHist','periEventBeta','periEventGamma');
