...
savePath = '/Users/mattgaidica/Documents/Data/ChoiceTask/LFPs/MachineLearning/trainingData-500msRT';
sevFile = '';
...
for iNeuron = 1:numel(LFPfiles_local)
    ...
    W = eventsLFPv2(curTrials(trialIds),sevDec,[0.5,1.5],Fs,freqList,eventFieldnames);
    ...
    for iTrial = 1:size(Wz,3)
        ...
        for iEvent = 1:7
            ...
            thisWz = squeeze(Wz(iEvent,Wrange,iTrial,:));
