...
switch lower(trialTypes)
    ...
    case 'montecarlo' % I don't think ChoiceRT has a montecarlo trialType - maybe comment it out? - JM20220513
    ...
    case {'allgo', 'all go'} %gives a trial struct for ALL trials. Do we need? JM 20220513
    ...
    case {'completedgo', 'completed go'}   % this excludes LH and MH failures, at least for now
        trialEventParams.trialType = 5;     % this one should keep JM 20220513
        trialEventParams.correct = -1;
        trialEventParams.countsAsTrial = 1;
        trialEventParams.tone = -1;
        trialEventParams.movementDirection = -1;
    ...
    case {'correctgo', 'correct go'} % this one should keep JM 20220513
        trialEventParams.trialType = 5;
        trialEventParams.correct = 1;
        trialEventParams.countsAsTrial = 1;
        trialEventParams.tone = -1;
    ...
    case {'correctgoright', 'correct go right'} %Keep JM 20220513
        trialEventParams.trialType = 5;
        trialEventParams.correct = 1;
        trialEventParams.countsAsTrial = 1;
        trialEventParams.tone = -1;
    ...
    case {'correctgoleft', 'correct go left'} %Keep JM 20220513
        trialEventParams.trialType = 5;
        trialEventParams.correct = 1;
        trialEventParams.countsAsTrial = 1;
        trialEventParams.tone = -1;
    ...
    case {'lhviol', 'lh viol', 'lhviolation', 'lh violation', 'lhfail', ... % trIdx extract trials is also empty here JM 20220513
            'lh fail'}
        trialEventParams.trialType = 5;
        trialEventParams.correct = 0;
        trialEventParams.countsAsTrial = -1;
    ...
    case {'wronggo', 'wrong go', 'wrong direction', 'wrongdirection', ... %Keep JM 20220513
    ...
    case {'allstop', 'all stop', 'stop'} % gives an empty array on the extractTrials function, might not need for current ChoiceRT JM 20220513
    ...
    case {'allnogo', 'all nogo', 'nogo'} % gives an empty array on the extractTrials function, might not need for current ChoiceRT JM 20220513
    ...
    case {'correctstop', 'correct stop'} % gives an empty array on the extractTrials function, might not need for current ChoiceRT JM 20220513
        trialEventParams.trialType = 3;
        trialEventParams.correct = 1;
        trialEventParams.countsAsTrial = 1;
        trialEventParams.tone = -1;
    ...
    case {'correctnogo', 'correct nogo'} % gives an empty array on the extractTrials function, might not need for current ChoiceRT JM 20220513
        trialEventParams.trialType = 2;
        trialEventParams.correct = 1;
        trialEventParams.countsAsTrial = 1;
        trialEventParams.tone = [];
    ...
    case {'failedstop', 'failed stop'} % gives an empty array on the extractTrials function, might not need for current ChoiceRT JM 20220513
        trialEventParams.trialType = 3;
        trialEventParams.correct = 0;
        trialEventParams.countsAsTrial = 1;
        trialEventParams.tone = -1;
    ...
    case {'failednogo', 'failed nogo'} % gives an empty array on the extractTrials function, might not need for current ChoiceRT JM 20220513
        trialEventParams.trialType = 2;
        trialEventParams.correct = 0;
        trialEventParams.countsAsTrial = 1;
        trialEventParams.tone = [];
    ...
    case {'any', 'all'} %gives a trial struct for ALL trials, same as allgo above. Do we need? JM 20220513
        trialEventParams.trialType = 0;
        trialEventParams.correct = -1;
        trialEventParams.countsAsTrial = -1;
        trialEventParams.tone = -1;
