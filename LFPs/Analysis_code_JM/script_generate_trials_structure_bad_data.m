...
%         end
        ...
        trials_structure = [parentFolder(1:end-9) 'LFP-eventFieldname-graphs'];
        ...
        for i_event = 1 : num_events
                   ...
                   % this function adds 2 fields to the trials structure to identify bad sites
                    trials_validchannels_marked = identify_bad_data(lfp_data, trials(trIdx), intan_site_order, probe_type);
