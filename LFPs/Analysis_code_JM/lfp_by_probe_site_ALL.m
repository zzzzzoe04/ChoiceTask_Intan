...
if strcmpi(probe_type, 'nn8x8')
   ...
   intan_amplifier = lfp_data([49:56,...%shank1, nn sites 1-8
            ...
            1:8,...%shank7
            9:16],:); %shank8
   intan_site_order = [6,4,5,4,8,1,7,2,...%shank 1 % This is the postion of the NNsites positioned dorsal to ventral
...
elseif strcmpi(probe_type, 'ASSY236')
    ...
    intan_amplifier = lfp_data([1:17,19:32,63,...% Shank A
        18,33:62, 64],:); % Shank B
    intan_site_order = [12,13,8,30,32,16,15,6,...% Shank A
            27,20,5,26,4,21,9,1,...
            29,19,14,28,24,31,22,7,...
            18,10,2,23,3,17,25,11,...
            63,62,39,47,36,61,33,57,...%shankB
            49,41,51,34,37,59,46,54,...
            40,52,56,60,43,38,55,42,...
            45,64,50,35,53,44,58,48];  
    site_order = [45,44,57,9,24,42,32,59,...% Shank A
        12,29,60,13,61,16,48,64,...
        11,28,43,25,26,10,27,58,...
        30,46,63,15,62,31,14,47,...
        50,51,3,17,5,52,8,56,...%shankB
...
%             40,52,56,60,43,38,55,42,...
%             45,64,50,35,53,44,58,48,...
%             12,13,8,30,32,16,15,6,...% Shank A
%             27,20,5,26,4,21,9,1,...
%             29,19,14,28,24,31,22,7,...
%             18,10,2,23,3,17,25,11];  
%     site_order = [50,51,3,17,5,52,8,56,...%shankB
%         40,22,38,7,23,54,18,34,...
%         2,37,33,53,21,4,35,1,...
%         19,49,39,6,36,20,55,41,...
%         45,44,57,9,24,42,32,59,...% Shank A
%         12,29,60,13,61,16,48,64,...
%         11,28,43,25,26,10,27,58,...
%         30,46,63,15,62,31,14,47];
