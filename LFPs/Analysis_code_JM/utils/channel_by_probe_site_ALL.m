...
function [channel_information, intan_site_order, intan_site_order_for_trials_struct, site_order] = channel_by_probe_site_ALL(probe_channel_info, probe_type)
...
if strcmpi(probe_type, 'nn8x8')
   ...
   intan_site_order_for_trials_struct = [54,51,53,52,56,49,55,50,...% WORKING ON VERIFYING IF THIS IS NEEDED - ONE TEST SUGGESTED YES BUT ANOTHER CHECK SUGGESTED THE ISSUE COULD BE FROM A DIFFERENT ISSUE
...
elseif strcmpi(probe_type, 'ASSY156')
     ...
     intan_site_order_for_trials_struct = [23,14,16,25,12,21,8,10,...
