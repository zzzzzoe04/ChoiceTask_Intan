function trials_validchannels_marked = identify_bad_data(lfp_data, trials, probe_type)
...
[ordered_lfp, intan_site_order, site_order] = lfp_by_probe_site_ALL(lfp_data, probe_type); % this orders the lfp data
...
% When adding to a script, need to create a formal naming system and new folder?