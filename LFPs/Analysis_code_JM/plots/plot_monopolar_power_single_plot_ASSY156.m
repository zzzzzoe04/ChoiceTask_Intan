...
function plot_monopolar = plot_monopolar_power_single_plot_ASSY156(power_lfps_fname, valid_sites_reordered)
...
for i_row = 1 : num_rows
    ...
    caption = sprintf('ASSY156 #%d', ASSY156_order(i_row)); % Make a catch so this doesn't need to be edited every graph
