function [allScalograms,allMRL,nScalograms,all_logScalograms] = tsScalogram_DKL_20170215(ts,sevFilt,tWindow,scaloWindow,Fs,freqList)
% upperPrctile = 85;
% lowerPrctile = 15;
